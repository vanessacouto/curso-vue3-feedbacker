<template>
  <div class="full h-3/4 flex flex-col justify-center items-center bg-brand-main">
  ...
  <div class="full h-3/4 flex flex-col justify-center items-center bg-brand-gray">
